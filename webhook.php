...
if (isset($update['message']['text']) && strpos($text, '/start') === 0) {
    ...
    if ($text === '/start' || $referrer_id) {
        ...
        $caption = "
            ...
            🟢  Upgrade your power and duration as you earn more KrypTix.
            🟢 Complete daily tasks and invite friends to boost your earnings!

            How to use guide follow the link below: 
            https://subtle-dodol-fedfcb.netlify.app/
        ";

        // If there was a referrer, include their ID in the link
        $referralLink = $referrer_id ? "https://subtle-dodol-fedfcb.netlify.app/?ref=$referrer_id" : "https://subtle-dodol-fedfcb.netlify.app/";
        ...
        if (file_exists($photoPath)) {
            ...
            $post_fields = [
                ...
                'reply_markup' => json_encode([
                    'inline_keyboard' => [
                        [
                            ['text' => 'Play KrypTix Now', 'web_app' => ['url' => $referralLink]],
